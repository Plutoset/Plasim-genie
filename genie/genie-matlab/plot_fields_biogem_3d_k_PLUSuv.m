function [] = plot_fields_biogem_3d_k_PLUSuv(PT,PVAR,PK,CSCALE,CMIN,CMAX,CN,PTIT)
...
%   *********************************************************
%
%   PLOT_FIELDS_BIOGEM_3D_K_PLUSUV(PT,PVAR,PK,CSCALE,CMIN,CMAX,CN,PTIT)
%   plots a k-section through the BIOGEM 3-D netCDF data file;
%   'fields_biogem_3d.nc'
%   This plotting differens from normal in 2 ways:
...
%
%   EXAMPLE;
%           plot_fields_biogem_3d_k_PLUSuv(1994.5,'ocn_PO4',8,1e-6,0,2,20,'PO_{4}')
...
filename = [runid, '_', num2str(time), '_', dataid, '_', 'k', num2str(kplot), '_PLUSuv.ps'];
