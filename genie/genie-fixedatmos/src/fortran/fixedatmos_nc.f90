...
module fixedatmos_nc

contains

  subroutine fixedatmos_ncwrite(filename,field,fieldname)

    use fixedatmos_common, only:rk,handle_err
  ...
  end subroutine fixedatmos_ncwrite

end module fixedatmos_nc
