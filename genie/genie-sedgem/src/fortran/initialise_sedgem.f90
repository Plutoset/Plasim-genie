...
SUBROUTINE initialise_sedgem( &
  ...
  print*,' '
  print*,'======================================================='
  print*,' Initialising SEDGEM sediment geochemistry module'
  print*,'======================================================='
  ...
  IF (ctrl_timeseries_output) THEN
     IF (ctrl_continuing.AND.ctrl_append_data.AND.(par_outdir_name.eq.par_rstdir_name)) THEN
  ...
  print*,'======================================================='
  print*,' Initialisation of SEDGEM sediment geogeochemistry module complete'
  print*,'======================================================='
  print*,' '
