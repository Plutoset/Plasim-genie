        ...
        MODULE FIXEDSEAICE__genmod
          INTERFACE 
            SUBROUTINE FIXEDSEAICE(ISTEP,TSTAR,SEAICE_FRAC,             &
     &ENERGYCARRY_ICE_OCN,ENERGYCARRY_OCN_ICE,DTCARRY_OCN_ICE,ALBEDO,   &
     &ILAND)
              INTEGER(KIND=4) :: ISTEP
              REAL(KIND=8) :: TSTAR(64,32)
              REAL(KIND=8) :: SEAICE_FRAC(64,32)
              REAL(KIND=8) :: ENERGYCARRY_ICE_OCN(64,32)
              REAL(KIND=8) :: ENERGYCARRY_OCN_ICE(64,32)
              REAL(KIND=8) :: DTCARRY_OCN_ICE(64,32)
              REAL(KIND=8) :: ALBEDO(64,32)
              INTEGER(KIND=4) :: ILAND(64,32)
            END SUBROUTINE FIXEDSEAICE
          END INTERFACE 
        END MODULE FIXEDSEAICE__genmod
