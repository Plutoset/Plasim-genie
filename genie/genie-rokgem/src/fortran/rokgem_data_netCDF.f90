...
CONTAINS
  ...
  SUBROUTINE rokgem_netcdf(dum_sfcatm1,dum_runoff,dum_photo,dum_respveg,dum_loc_P,                                   &
       ...
       REAL,INTENT(in)                 :: dum_runoff(n_i,n_j)                                      ! runoff from EMBM
       ...
       REAL,INTENT(in)                 :: dum_force_flux_weather_o_ocean(n_ocn,n_i,n_j)            ! fluxes into coastal positions in ocean (ocean variables)     
           ...
           CALL sub_save_netcdf_2d_rg(dum_sfcatm1,dum_runoff,dum_photo,dum_respveg,dum_loc_P, &
  ...
  SUBROUTINE sub_save_netcdf_2d_rg(dum_sfcatm1,dum_runoff,dum_photo,dum_respveg,dum_loc_P,                                    &
                                  & dum_force_flux_weather_a_land,dum_force_flux_weather_o_land,dum_force_flux_weather_o_ocean)
    ...
    DO i=1,n_i
       DO j=1,n_j
          loc_ij(i,j) = dum_sfcatm1(ia_T,i,j)
       END DO
    END DO
    ...
    DO i=1,n_i
       DO j=1,n_j
          loc_ij(i,j) = dum_sfcatm1(ia_PCO2,i,j)
       END DO
    END DO
    ...
    loc_unitsname = 'GtC/yr'
    loc_ij(:,:) = dum_respveg(:,:)
    call sub_adddef_netcdf(loc_iou,3,'resp_veg','Vegitation Respiration',trim(loc_unitsname),const_real_zero,const_real_zero)
