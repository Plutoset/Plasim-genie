...
! COUPLE FLUXES: rok->atm
 SUBROUTINE cpl_flux_rokatm(    &
  ...
  real,dimension(dum_n_maxatm,dum_n_maxi,dum_n_maxj),intent(in)::dum_sfxatm1
...
!  end DO
   ...
   dum_sfxsumatm(ia_PCO2,:,:) = dum_sfxsumatm(ia_PCO2,:,:) + dum_dts*dum_sfxatm1(ia_PCO2,:,:)
   !print*,'dum_sfxsumatm(ia_PCO2,:,:)',dum_sfxsumatm(ia_PCO2,:,:)
