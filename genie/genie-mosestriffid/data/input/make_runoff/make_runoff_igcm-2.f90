...
PROGRAM make_runoff_igcm_2
  ...
  !####################################################
  CALL open_file_nc('../../../../genie-igcm3/data/input/limit_goldstein.nc',nco1)
  ...
  CALL initialise_tethys(1,1,ny,nx,lsmaski,lats,lons,'runoff_mask_igcm-2_64x32.nc')
  CALL makemaps('routeing_igcm-2.dat')
...
END PROGRAM make_runoff_igcm_2
