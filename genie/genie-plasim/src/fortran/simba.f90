...
implicit none
      ...
      namelist/entspar/k7,k8,k9,k10,k11a,k11b,k12,k13,k14,k16	&
     &		,k17,k18,k20,k24,k26,k29,k31,k32,kz,tadj

      namelist/entsplasim/ qthresh
...
!! PBH temporary path
 open(12,file='../../genie/genie-plasim/config/veg_namelist',form='formatted')
 read(12,entspar)
 write (*,'(/," *****************************************")')
