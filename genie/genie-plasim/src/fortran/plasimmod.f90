...
!
      integer NTRACE,NLON,NTRU,NLPP,NHOR,NUGP,NPGP,NLEM,NLEP,NLSQ, &
              NTP1,NRSP,NCSP,NSPP,NESP,NVCT,NZOM,NROOT
...
!     ***********************
      ...
      real :: co2   =   360.0  ! atm. co2 concentration for radiation (ppmv) i.e. CO2eff
      real :: co2veg  = 360.0  ! atm. co2 concentration for vegetationc(ppmv)
...
!     ******************************
      ...
      real AKAP_EARTH,AKAP_MARS,ALR_EARTH,ALR_MARS,GA_EARTH,GA_MARS,   &
           GASCON_EARTH,GASCON_MARS,PLARAD_EARTH,PLARAD_MARS,          &
           PNU_EARTH,PNU_MARS,SID_DAY_EARTH,SID_DAY_MARS,              &
           SOL_DAY_EARTH,SOL_DAY_MARS,RA1_LIQUID,RA2_LIQUID,RA4_LIQUID,&
           RA1_ICE,RA2_ICE,RA4_ICE, SOLCON_EARTH,SOLCON_MARS,          &
           ECCEN_EARTH,ECCEN_MARS,OBLIQ_EARTH,OBLIQ_MARS,              &
           LOPER_EARTH,LOPER_MARS
