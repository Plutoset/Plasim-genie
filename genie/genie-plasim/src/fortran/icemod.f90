...
!
      if (mypid == NROOT) then
!! PBH temporary path
         open(20,file='../../genie/genie-plasim/config/ice_namelist',form='formatted')
         read(20,icepar)
         write (*,'(/," ***************************************")')
...
!temporary path and filename (generalise this)
      IF(NLAT.EQ.32) THEN
        open(10,file='../../genie/genie-plasim/data/input/T21/N032_surf_0709.sra',form='formatted')
      ELSE IF(NLAT.EQ.64) THEN
        open(10,file='../../genie/genie-plasim/data/input/T42/N064_surf_0709.sra',form='formatted')
      ELSE
