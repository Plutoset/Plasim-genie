      subroutine write_netcdf_igcm(filename,data2,invarname)
...
c     this version for igcm-grid (see also write_netcdf_std.f)
...
c     FOR GRID:
      ...
      call restructure1(data2,data1,mg,jg,nhem,1.,0.,1)
