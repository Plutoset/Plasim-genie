...
C     ; REFLECTION FROM UNDERLYING LAYER
      ...
      INTEGER NLON,JLON
      REAL    ZFF,ZGP,ZTOP,ZWCP,ZDT,ZX1,ZWM,ZRM2,ZZRK,ZX2,ZRP
      REAL    ZALPHA,ZBETA,ZEXMUO,ZEXKP,ZEXKM,ZXP2P,ZXM2P
      REAL    ZAP2B,ZAM2B,ZA11,ZA12,ZA13,ZA22,ZA21,ZA23,ZDENA
      REAL    ZC1A,ZC2A,ZRI0A,ZRI1A,ZRI0B,ZRI1B,ZB21,ZB22,ZB23
      REAL    ZDENB,ZC1B,ZC2B,ZRI0C,ZRI1C,ZRI0D,ZRI1D
...
C     
         ...
         ZX1 = 1.-ZWCP*ZGP
         ZWM = 1.-ZWCP
c        This is a test to stop zwm less than 0, which 
c          leads to the square root of a negative number...
         zwm=max(zwm,1e-5)
