...
#define clip_ordxrange(c,x1,x2)		clip_ordxrange_(c,x1,x2,return,)
#define clip_ordyrange(c,y1,y2)		clip_ordyrange_(c,y1,y2,return,)
#define clip_xrange(c,x1,x2)		clip_xrange_(c,x1,x2,return,)
#define clip_yrange(c,y1,y2)		clip_yrange_(c,y1,y2,return,)
#define clip_ordbox(c,x1,y1,x2,y2)	clip_ordbox_(c,x1,y1,x2,y2,return,)
#define clip_box(c,x1,y1,x2,y2)		clip_box_(c,x1,y1,x2,y2,return,)
...
#define cxclip_ordxrange(c,x1,x2)	cxclip_ordxrange_(c,x1,x2,return,)
#define cxclip_ordyrange(c,y1,y2)	cxclip_ordyrange_(c,y1,y2,return,)
#define cxclip_xrange(c,x1,x2)		cxclip_xrange_(c,x1,x2,return,)
#define cxclip_yrange(c,y1,y2)		cxclip_yrange_(c,y1,y2,return,)
#define cxclip_ordbox(c,x1,y1,x2,y2)	cxclip_ordbox_(c,x1,y1,x2,y2,return,)
#define cxclip_box(c,x1,y1,x2,y2)	cxclip_box_(c,x1,y1,x2,y2,return,)

#define clip_hline(c,x1,x2,y)		clip_hline_(c,x1,x2,y,return,)
#define clip_vline(c,x,y1,y2)		clip_vline_(c,x,y1,y2,return,)
#define clip_line_xmin(c,x1,y1,x2,y2)	clip_line_xmin_(c,x1,y1,x2,y2,)
#define clip_line_xmax(c,x1,y1,x2,y2)	clip_line_xmax_(c,x1,y1,x2,y2,)
#define clip_line_ymin(c,x1,y1,x2,y2)	clip_line_ymin_(c,x1,y1,x2,y2,)
#define clip_line_ymax(c,x1,y1,x2,y2)	clip_line_ymax_(c,x1,y1,x2,y2,)
#define clip_line(c,x1,y1,x2,y2)	clip_line_(c,x1,y1,x2,y2,return,)
