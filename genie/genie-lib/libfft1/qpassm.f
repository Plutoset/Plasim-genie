...
C
     ...
     *    LA,IERR)
      IMPLICIT NONE
      INTEGER N,M,IFAC,IINK,LA,INC1,JINK,INC2,IJUMP,KSTOP,IBAD,LOT
      INTEGER IBASE,JBASE,IGO,IA,IB,JA,JB,L,I,J,IJK,INC3,INC4,K
      INTEGER KB,IC,JC,KC,ID,JD,KD,IE,JE,KE,IF,JF,KF,IG,IH,IERR
      REAL    SIN36,SIN72,QRT5,SIN60,C,A,C1,TRIGS,S1,B,D,Z,C2
      REAL    S2,A1,B1,A2,B2,A3,B3,ZSIN60,C3,S3,A0,B0,SIN45
      REAL    A4,A5,A6,C4,S4,B4,B5,B6,A10,A20,B10,B20,A11,A21
      REAL    B11,B21,ZQRT5,ZSIN36,ZSIN72,C5,S5,ZSIN45
