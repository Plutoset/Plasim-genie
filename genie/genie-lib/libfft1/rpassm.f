...
C
     ...
     *    LA,IERR)
      IMPLICIT NONE
      INTEGER N,M,IFAC,IINK,LA,INC1,JINK,INC2,KSTOP,IBAD,LOT
      INTEGER IBASE,JBASE,IGO,IA,IB,JA,JB,L,I,J,IJK,INC3,INC4,K
      INTEGER KB,IC,JC,KC,ID,JD,KD,IE,JE,KE,IF,JF,KF,IERR
      INTEGER JUMP,JG,JH
      REAL    SIN36,SIN72,QRT5,SIN60,C,A,C1,TRIGS,S1,B,D,C2
      REAL    S2,C3,S3,SIN45
      REAL    C4,S4,A10,A20,B10,B20,A11,A21
      REAL    B11,B21,C5,S5
      REAL    SSIN60,QQRT5,SSIN36,SSIN72,SSIN45
