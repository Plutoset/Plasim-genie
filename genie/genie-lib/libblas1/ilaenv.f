...
c      INTEGER          FUNCTION ILAENV( ISPEC, NAME, OPTS, N1, N2, N3,
     ...
     $                 N4 )
*
c     N.B. for genie, this routine has had the argument OPTS,N3 removed,
c       as it was never used.  Also needed to change the calling routines:
c       sgetri, strtri,sgetrf 
c
